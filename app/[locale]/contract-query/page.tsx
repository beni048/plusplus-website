...
export default function ContractQueryPage() {
  ...
  const pdfTranslations = {
    title: locale === 'de' ? 'Kontostand' : 'Account Balance',
    customerNumber: locale === 'de' ? 'Kundennummer' : 'Customer Number',
    date: locale === 'de' ? 'Datum' : 'Date',
    depositDate: t('contractQuery.fields.depositDate'),
    principal: t('contractQuery.fields.principal'),
    timeSinceDeposit: t('contractQuery.fields.timeSinceDeposit'),
    currentValue: t('contractQuery.fields.currentValue'),
    gainSinceDeposit: t('contractQuery.fields.gainSinceDeposit'),
    bitcoinAmount: t('contractQuery.fields.bitcoinAmount'),
    bitcoinPrice: locale === 'de' ? 'Bitcoin Preis' : 'Bitcoin Price',
    metric: locale === 'de' ? 'Metrik' : 'Metric',
    value: locale === 'de' ? 'Wert' : 'Value',
    generatedBy: locale === 'de' ? 'Generiert von' : 'Generated by'
  };
                  ...
                  <div className="space-y-6">
                    ...
                    <form onSubmit={handleZchfSubmit}>
                      <div className="flex items-center gap-2 mb-3">
                        <label className="text-sm font-medium text-black font-secondary">
                        ...
                        <Popover>
                          ...
                          <PopoverContent className="w-80 text-sm font-secondary whitespace-pre-wrap">
                            {t('contractQuery.customerNumberInfo')}
                          </PopoverContent>
                        </Popover>
                      </div>
                    ...
                    {zchfQuery.depositDetails && zchfQuery.depositDetails.initialAmount > 0n && !zchfQuery.isLoading && (
                      <div className="space-y-6">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              generateContractPdf(
                                ...
                                zchfCustomerNumber,
                                {
                                  depositDate: zchfDateQuery.depositStats?.depositDate.formattedDate || '',
                                  principal: (Number(zchfQuery.depositDetails.initialAmount) / 10 ** 18).toLocaleString('de-CH', { maximumFractionDigits: 2 }),
                                  timeSinceDeposit: zchfDateQuery.depositStats?.formattedTimeSinceDeposit || '',
                                  currentValue: ((Number(zchfQuery.depositDetails.initialAmount) + Number(zchfQuery.depositDetails.netInterest)) / 10 ** 18).toLocaleString('de-CH', { maximumFractionDigits: 2 }),
                                  gain: ((Number(zchfQuery.depositDetails.netInterest)) / 10 ** 18).toLocaleString('de-CH', { maximumFractionDigits: 2 }),
                                  gainPercentage: Number(zchfQuery.depositDetails.initialAmount) > 0 ? ((Number(zchfQuery.depositDetails.netInterest) / 10 ** 18) / (Number(zchfQuery.depositDetails.initialAmount) / 10 ** 18) * 100).toFixed(2) : '0.00'
                                },
                                pdfTranslations,
                                locale
                              );
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <Card className={`p-4 bg-gradient-to-br border-2 ${zchfQuery.depositDetails && Number(zchfQuery.depositDetails.netInterest) / 10 ** 18 >= 0
                    ...
                    {wbtcQuery.valueInSatoshis !== undefined && wbtcQuery.valueInSatoshis > 0n && !wbtcQuery.isLoading && (
                      <div className="space-y-6">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              generateContractPdf(
                                ...
                                wbtcCustomerNumber,
                                {
                                  depositDate: wbtcDateQuery.depositStats?.depositDate.formattedDate || '',
                                  principal: wbtcDateQuery.depositStats ? Math.round(wbtcDateQuery.depositStats.valueAtCreation).toLocaleString('de-CH') : '',
                                  timeSinceDeposit: wbtcDateQuery.depositStats?.formattedTimeSinceDeposit || '',
                                  currentValue: Math.round(convertSatoshisToCHF(wbtcQuery.valueInSatoshis, bitcoinPrice)).toLocaleString('de-CH'),
                                  gain: wbtcDateQuery.depositStats ? Math.round(wbtcDateQuery.depositStats.valueGain).toLocaleString('de-CH') : '',
                                  gainPercentage: wbtcDateQuery.depositStats ? wbtcDateQuery.depositStats.percentageGain.toFixed(2) : '0.00',
                                  bitcoinAmount: (Number(wbtcQuery.valueInSatoshis) / 10 ** 8).toLocaleString('de-CH', { maximumFractionDigits: 8 }),
                                  bitcoinPrice: formatBitcoinPrice(bitcoinPrice)
                                },
                                pdfTranslations,
                                locale
                              );
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <Card className={`p-4 bg-gradient-to-br border-2 ${wbtcDateQuery.depositStats && wbtcDateQuery.depositStats.valueGain >= 0
                            ? 'from-emerald-50 to-emerald-100/50 border-emerald-300'
                            : 'from-red-50 to-red-100/50 border-red-300'
                            }`}>
                            <p className="text-xs font-semibold uppercase tracking-wider mb-2 font-secondary" style={{
