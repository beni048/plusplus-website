    ...
    <main className="min-h-screen bg-neutral-light pt-32 pb-24">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="mb-12 text-center text-4xl font-primary font-medium text-black">{t('title')}</h1>
          
          <div className="prose prose-lg max-w-none text-neutral-dark">
            <p className="text-lg font-secondary leading-relaxed mb-8">
              {t('intro')}
            </p>

            <h2 className="text-2xl font-primary font-semibold text-black mb-4 mt-8">{t('section1.title')}</h2>
            <p className="text-lg font-secondary leading-relaxed mb-6" dangerouslySetInnerHTML={{ __html: t('section1.content') }} />
            ...
            <p className="text-lg font-secondary leading-relaxed mb-6">
            ...
            <p className="text-lg font-secondary leading-relaxed mb-4">
              {t('section2.subsection3.content1')}
            </p>
            <ul className="text-lg font-secondary leading-relaxed mb-6 ml-6 list-disc">
            ...
            <p className="text-lg font-secondary leading-relaxed mb-2" dangerouslySetInnerHTML={{ __html: t('section2.subsection5.content1') }} />
            <p className="text-lg font-secondary leading-relaxed mb-6">
