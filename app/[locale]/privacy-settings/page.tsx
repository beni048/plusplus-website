      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-lg font-secondary leading-relaxed text-neutral-dark max-w-3xl mx-auto">
              {t('pageSubtitle')}
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none text-neutral-dark">
            ...
            <ul className="text-lg font-secondary leading-relaxed mb-8 ml-6 list-disc space-y-3">
