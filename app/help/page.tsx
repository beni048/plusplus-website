        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="how-it-works">
              <AccordionTrigger className="text-xl">How does it work?</AccordionTrigger>
              <AccordionContent className="text-gray-600 leading-relaxed">
            ...
            <AccordionItem value="returns">
              <AccordionTrigger className="text-xl">What returns can I expect?</AccordionTrigger>
              <AccordionContent className="text-gray-600 leading-relaxed">
            ...
            <AccordionItem value="get-started">
              <AccordionTrigger className="text-xl">How can I get started?</AccordionTrigger>
              <AccordionContent className="text-gray-600 leading-relaxed">
